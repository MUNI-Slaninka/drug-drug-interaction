...
class EnsembleModel(Model):
    ...
    def calculate(self, full_drug_drug_matrix, test_position):
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "chem_neighbor"
        )
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "target_neighbor"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "transporter_neighbor"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "enzyme_neighbor"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "pathway_neighbor"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "indication_neighbor"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "label_neighbor"
        )
        multiple_result.append(results)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "offlabel_neighbor"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "chem_label"
        )
        multiple_result.append(results)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "target_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "transporter_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "enzyme_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "pathway_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "indication_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "label_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "offlabel_label"
        )
        multiple_result.append(results)
        ...
        # predict_matrix=AA_similarity_matrix
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "AA_similarity_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        # predict_matrix=RA_similarity_matrix
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "RA_similarity_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        # predict_matrix=ACT_similarity_matrix
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "ACT_similarity_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        # predict_matrix=RWR_similarity_matrix
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "RWR_similarity_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
        ...
        results = super().evaluate(
            full_drug_drug_matrix, predict_matrix, test_position, "disturb_matrix_label"
        )
        multiple_result.append(results)
        multiple_matrix.append(predict_matrix)
    ...
    def train(self):
        ...
        self.train_drug_drug_matrix = train_drug_drug_matrix
        [multiple_matrix, multiple_result] = self.calculate(
            copy.deepcopy(full_drug_drug_matrix), test_position
        )
        weights = self._get_paramter(
            copy.deepcopy(full_drug_drug_matrix), multiple_matrix, test_position
        )
        # weights=[]
        ...
        for i in range(0, len(test_position)):
            ...
            for j in range(0, len(multiple_matrix)):
                vector.append(
                    multiple_matrix[j][test_position[i][0], test_position[i][1]]
                )
            input_matrix.append(vector)
            output_matrix.append(
                full_drug_drug_matrix[test_position[i][0], test_position[i][1]]
            )

        input_matrix = np.array(input_matrix)
        output_matrix = np.array(output_matrix)
        clf1 = linear_model.LogisticRegression(
            C=1.0, penalty="l1", tol=1e-6, solver="liblinear"
        )
    ...
    def ensemble_scoring(
        real_matrix, multiple_matrix, test_position, weights, cf1, cf2
    ):
        real_labels = []
        for i in range(0, len(test_position)):
        ...
        for i in range(0, len(multiple_matrix)):
            ...
            for j in range(0, len(test_position)):
                predicted_probability.append(
                    predict_matrix[test_position[j][0], test_position[j][1]]
                )
        ...
        for i in range(0, len(multiple_matrix)):
            ensemble_prediction = (
                ensemble_prediction + weights[i] * multiple_prediction[i]
            )
        ...
        normalize = MinMaxScaler()
        ensemble_prediction = normalize.fit_transform(
            np.array(ensemble_prediction).reshape(-1, 1)
        )

        result = Model.calculate_metric_score(
            real_labels, (np.array(ensemble_prediction).reshape(-1))
        )
    ...
    def fit_function(individual, parameter1, parameter2):
        ...
        for i in range(0, len(multiple_prediction)):
            ensemble_prediction = (
                ensemble_prediction + individual[i] * multiple_prediction[i]
            )
    ...
    def _get_paramter(real_matrix, multiple_matrix, test_position):
        ...
        creator.create(
            "Individual", array.array, typecode="d", fitness=creator.FitnessMax
        )
    ...
    def _topology_similarity_matrix(self):
        ...
        katz_similarity_matrix = LA.pinv(
            np.identity(drug_num) - beta * drug_drug_matrix
        ) - np.identity(drug_num)
        for i in range(0, drug_num):
            for j in range(i + 1, drug_num):
                ...
                for k in range(0, len(commonn_neighbor)):
                    aa_score = aa_score + 1 / math.log(
                        len(list(g.neighbors(commonn_neighbor[k])))
                    )
                    ra_score = ra_score + 1 / len(
                        list(g.neighbors(commonn_neighbor[k]))
                    )
    ...
    def _neighbor_method(self, similarity_matrix):
        return_matrix = np.matrix(self.train_drug_drug_matrix) * np.matrix(
            similarity_matrix
        )
    ...
    def _label_propagation(self, similarity_matrix):
        ...
        transform_matrix = (1 - alpha) * LA.pinv(
            np.identity(len(similarity_matrix)) - alpha * n
        )
    ...
    def _disturb_matrix_method(self):
        ...
        for i in range(0, num_eigenvalues):
            delta_eigenvalues[i] = (
                np.transpose(eigenvectors[:, i]) * delta_a * eigenvectors[:, i]
